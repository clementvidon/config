...
function! AppendSchedule(option)
    if a:option == "bda"
        ...
        call append(line('$'), '- ( 21:00 21:30 ) sidework: study transactional analysis')
        call append(line('$'), '- ( 20:40 21:00 ) achiever: update journal')
        ...
        call append(line('$'), '- ( 05:50 06:00 ) self_rel: exercise ( 15min stretch )')
    elseif a:option == "42"
        call append(line('$'), '')
...
function! AppendJournal()
    ...
    call append(line('$'), '================================================================================')
    call append(line('$'), 'DAWN->>>')
    call append(line('$'), 'LEGEND')
    call append(line('$'), '  Item                        : Value ( Keywords )')
    call append(line('$'), '')
    call append(line('$'), 'SLEEP')
    call append(line('$'), '  Went to bed   At            : --:--')
    call append(line('$'), '  Sleep started At            : --:--')
    ...
    call append(line('$'), '  Stretch       Duration      : 00:00')
    call append(line('$'), '  Exercise      Duration      : 00:00')
    call append(line('$'), '  Meditation    Duration      : 00:00')
    call append(line('$'), '')
