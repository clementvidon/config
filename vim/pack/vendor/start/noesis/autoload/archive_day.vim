...
function! AppendJournal()
    ...
    call append(line('$'), 'TODO ABSOLUTE DAY')
    call append(line('$'), '  Phone            Duration  : 00:00')
    call append(line('$'), '  Steps            Count     : 0')
    call append(line('$'), '<<<-')
    call append(line('$'), 'TODO ESSENTIAL EXPENSES ->>>')
    ...
    call append(line('$'), 'TODO NON-ESSENTIAL EXPENSES')
