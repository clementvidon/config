...
function! AppendSchedule(option)
    ...
    if a:option == "temp"
        ...
        call append(line('$'), '- ( 14:00 19:00 ) mainwork: @employment study dsa and go ( neetcode / X )')
        call append(line('$'), '#------------------- life_env ↓')
        call append(line('$'), '- ( 13:40 14:00 ) life_env: meditate ( cardiac coherence )')
        ...
        call append(line('$'), '#------------------- achiever ↓')
        call append(line('$'), '- ( 07:30 07:45 ) achiever: import phone notes')
        ...
        " call append(line('$'), '- ( 14:00 19:00 ) mainwork: @employment/basic_saas study go and tdd ( quii go-with-tests / X )')
        ...
        " call append(line('$'), '- ( 07:45 12:30 ) mainwork: @employment study dsa and go ( neetcode / X )')
        " call append(line('$'), '- ( 07:30 07:45 ) achiever: update journal ; import phone notes')
        " call append(line('$'), '- ( 07:20 07:30 ) life_env: make breakfast')
        " call append(line('$'), '- ( 07:05 07:20 ) life_env: prepare ( wash )')
        " call append(line('$'), '- ( 06:45 07:05 ) life_env: exercise ( warm-up )')
        " call append(line('$'), '- TODO 22:30 06:45 life_env: sleep')
        ...
        " call append(line('$'), '- ( 14:30 19:30 ) mainwork: @employment/basic_saas study go and tdd ( quii go-with-tests / X )')
        ...
        " call append(line('$'), '- ( 16:00 19:20 ) mainwork: @employment/basic_saas study go and tdd ( quii go-with-tests / X )')
        ...
        " call append(line('$'), '- ( 09:00 12:00 ) mainwork: @employment/basic_saas study go and tdd ( quii go-with-tests / X )')
        ...
        " call append(line('$'), '- ( 19:00 19:30 ) achiever: update journal')
        " call append(line('$'), '- ( 15:30 19:00 ) mainwork: @employment/basic_saas study go and tdd ( quii go-with-tests / X )')
