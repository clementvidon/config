...
function! AppendJournal()
    ...
    call append(line('$'), '')
    call append(line('$'), '  Last Sleep')
    call append(line('$'), '    Start At        : X')
    call append(line('$'), '    Duration        : X')
    call append(line('$'), '    Quality         : X')
    ...
    call append(line('$'), '    Comments: X')
    call append(line('$'), '')
    call append(line('$'), '  Main Work')
    call append(line('$'), '    Duration        : X')
    call append(line('$'), '    Quality         : X')
    call append(line('$'), '    Focus           : X')
    call append(line('$'), '    Enthusiasm      : X')
    call append(line('$'), '    Satisfaction    : X')
