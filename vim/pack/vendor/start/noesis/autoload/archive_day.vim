...
function! AppendSchedule(option)
    ...
    if a:option == "temp"
        ...
        call append(line('$'), '- ( 19:45 21:45 ) work_env: clear X notes')
        ...
        call append(line('$'), '- ( 12:40 14:05 ) work_env: clear X notes')
        ...
        call append(line('$'), '- ( 07:10 07:45 ) self_rel: read the pragmatic programmer ( 2% )')
        call append(line('$'), '- ( 07:00 07:10 ) life_env: prepare breakfast')
...
function! AppendJournal()
    ...
    call append(line('$'), '  - ventral sheathing 30s : 0')
    call append(line('$'), '  - scissor kick       40 : 0')
    call append(line('$'), '  - flexion            20 : 0')
    call append(line('$'), '  - push up            15 : 0')
    call append(line('$'), '  - high kick        2x15 : 0')
    call append(line('$'), '  - wheel              10 : 0')
    call append(line('$'), '')
    call append(line('$'), '<<<-')
endfunction
