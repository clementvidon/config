...
function! AppendSchedule(option)
    ...
    if a:option == "temp"
        ...
        call append(line('$'), '- ( 13:40 14:00 ) self_rel: meditate ( focus meditation + cardiac coherence )')
        ...
        call append(line('$'), '- ( 10:00 11:10 ) sidework: @svelte study')
        call append(line('$'), '- ( 08:00 10:00 ) sidework: @nestjs study')
        call append(line('$'), '- ( 07:50 08:00 ) work_env: update achiever journal')
        call append(line('$'), "- ( 07:00 07:45 ) self_rel: read l'analyse transactionnelle")
    ...
    elseif a:option == "42"
        ...
        call append(line('$'), '- ( 20:20 20:50 ) self_rel: study transactional analysis + dine')
...
function! AppendJournal()
    ...
    call append(line('$'), '  - ventral sheathing 30s : -')
    call append(line('$'), '  - scissor kick       40 : -')
    call append(line('$'), '  - flexion            20 : -')
    call append(line('$'), '  - push up            15 : -')
    call append(line('$'), '  - high kick        2x15 : -')
    call append(line('$'), '  - wheel              10 : -')
    call append(line('$'), '')
    call append(line('$'), '<<<-')
endfunction
