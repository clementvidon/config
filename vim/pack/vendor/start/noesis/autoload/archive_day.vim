...
function! AppendSchedule(option)
    ...
    if a:option == "temp"
        ...
        call append(line('$'), '- ( 08:15 08:50 ) life_env: take care of yuki ( meal, walk ) ; make tea')
        ...
        " call append(line('$'), '- ( 11:45 12:00 ) life_env: prepare ( shower, dress)')
