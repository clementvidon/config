...
function! AppendSchedule(option)
    if a:option == "bda"
        ...
        call append(line('$'), '- ( 20:40 20:50 ) work_env: update achiever')
        call append(line('$'), '- X')
        call append(line('$'), '- ( 19:45 20:15 ) work_env: update achiever')
        ...
        call append(line('$'), '- maingoal: @42 X')
        call append(line('$'), '- ( 06:55 07:05 ) work_env: update achiever')
    ...
    elseif a:option == "home"
        call append(line('$'), '')
        call append(line('$'), '- ( 21:20 21:30 ) self_rel: exercise ( 10min stretch )')
        call append(line('$'), '- ( 20:50 21:20 ) work_env: update achiever')
        call append(line('$'), '- ( 20:20 20:50 ) sidework: study transactional analysis + lunch')
        ...
        call append(line('$'), '- maingoal: @42 X')
        call append(line('$'), '- ( 13:45 14:00 ) self_rel: meditate ( 10min void )')
        call append(line('$'), '- ( 13:30 13:45 ) work_env: update achiever')
        ...
        call append(line('$'), '- maingoal: @42 X')
        call append(line('$'), '- ( 07:00 07:10 ) work_env: update achiever')
