...
function! AppendSchedule(option)
    if a:option == "bda"
        ...
        call append(line('$'), '- ( 16:45 17:00 ) wellness: chill')
        call append(line('$'), '- ( 14:00 16:45 ) maingoal: @42 X')
        call append(line('$'), '- ( 13:45 14:00 ) wellness: meditate ( 10min void )')
        ...
        call append(line('$'), '- ( 11:20 11:50 ) wellness: exercise ( 5min warm-up, 20min run, 5min stretch )')
        call append(line('$'), '- ( 11:10 11:20 ) wellness: chill')
        call append(line('$'), '- ( 09:05 11:10 ) maingoal: @42 X')
        call append(line('$'), '- ( 09:00 09:05 ) wellness: chill')
        ...
        call append(line('$'), '- ( 06:00 06:15 ) wellness: meditate ( 10min mindfulness )')
