...
function! AppendSchedule(option)
    if a:option == "bda"
        ...
        call append(line('$'), '- ( 21:40 21:50 ) wellness: exercise ( 10min stretch )')
        call append(line('$'), '- ( 21:00 21:40 ) sidework: study transactional analysis')
        call append(line('$'), '- ( 20:30 21:00 ) work_env: update journal and todo')
        call append(line('$'), '- ( 19:40 20:30 ) life_env: clear phone notes')
        call append(line('$'), '- ( 19:00 19:40 ) fam_rela: dine with moupou')
        call append(line('$'), '- ( 14:00 19:00 ) maingoal: @42/ft_transcendence study react')
        call append(line('$'), '- ( 13:50 14:00 ) wellness: meditate ( 10min void )')
        call append(line('$'), '- ( 13:40 13:50 ) work_env: update journal')
        call append(line('$'), '- ( 12:40 13:40 ) work_env: clear X notes')
        call append(line('$'), '- ( 12:00 12:40 ) fam_rela: lunch with moupou')
        call append(line('$'), '- ( 11:50 12:00 ) prepare')
        call append(line('$'), '- ( 11:10 11:50 ) wellness: exercise ( 5min warm-up, 20min run, 5min stretch )')
        call append(line('$'), '- ( 07:00 11:10 ) maingoal: @42/inception study docker')
        call append(line('$'), '- ( 06:50 07:00 ) wellness: meditate ( 10min mindfulness )')
        call append(line('$'), '- ( 06:00 06:50 ) sidework: study transactional analysis')
        call append(line('$'), '- ( 05:50 06:00 ) wellness: exercise ( 10min warm-up )')
        call append(line('$'), '    Skipped:')
