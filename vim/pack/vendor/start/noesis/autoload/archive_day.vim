...
function! AppendSchedule(option)
    ...
    if a:option == "temp"
        ...
        call append(line('$'), '- ( 19:45 21:45 ) life_env: clear X notes')
        ...
        call append(line('$'), '- ( 12:40 14:05 ) life_env: clear X notes')
        ...
        call append(line('$'), '- ( 07:00 07:45 ) self_rel: read the pragmatic programmer ( 2% )')
