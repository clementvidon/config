...
function! AppendSchedule(option)
    ...
    if a:option == "temp"
        ...
        call append(line('$'), '- ( 08:30 12:30 ) maingoal: @employment practice coding tests ( hackerrank.com / c )')
        call append(line('$'), '- ( 08:15 08:30 ) achiever: update journal ; import phone notes')
        call append(line('$'), '- ( 08:00 08:15 ) life_env: prepare ( wash )')
        call append(line('$'), '- ( 07:10 08:00 ) maingoal: @employment read the pragmatic programmer ( 3% )')
        call append(line('$'), '- ( 07:00 07:10 ) life_env: make breakfast')
        call append(line('$'), '- ( 06:50 07:00 ) self_rel: exercise ( warm-up )')
        call append(line('$'), '- ( 06:45 06:50 ) self_rel: wake-up')
