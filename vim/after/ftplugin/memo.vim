...
function! MemoArchiveDay()
    ...
    " call append(l:tomorrow_loc + 1, "[-][>>]")
    " call append(l:tomorrow_loc + 1, "[-][>>] workout:   pullup                   5       x1")
    ...
    call append(l:tomorrow_loc + 1, "[-][>>] ingestion_other: X, magnesium")
    call append(l:tomorrow_loc + 1, "[-][>>]")
    ...
    "   bda TODO wake up at 06, start work at 06:30

    " call append(l:tomorrow_loc + 1, "[(06:20)][0] wake up + stretch)")
    " call append(l:tomorrow_loc + 1, "[(06:30)][0] breakfast + stretch")
    " call append(l:tomorrow_loc + 1, "[(06:50)][0] meditate (empty mind) {}")
    " call append(l:tomorrow_loc + 1, "X")
    " call append(l:tomorrow_loc + 1, "[(09:15)][0] stretch + X")
    " call append(l:tomorrow_loc + 1, "X")
    ...
    " call append(l:tomorrow_loc + 1, "[(13:40)][0] meditate (empty mind) {}")
    " call append(l:tomorrow_loc + 1, "[(13:50)][0] @noesis/todo clear and update")
    " call append(l:tomorrow_loc + 1, "X")
    " call append(l:tomorrow_loc + 1, "[(16:00)][0] stretch + X")
    " call append(l:tomorrow_loc + 1, "X")
    " call append(l:tomorrow_loc + 1, "[(19:00)][0] dine with poumou")
    " call append(l:tomorrow_loc + 1, "[(19:40)][0] clear inboxes + watch tv")
    " call append(l:tomorrow_loc + 1, "[(20:00)][0] @noesis/X clear + watch tv")
    " call append(l:tomorrow_loc + 1, "[(20:40)][0] @noesis/todo clear and update")
    " call append(l:tomorrow_loc + 1, "[(20:50)][0] meditate (gratitude)")
