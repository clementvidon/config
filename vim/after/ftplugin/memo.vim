...
function! MemoArchiveDay()
    ...
    call append(l:tomorrow_loc + 1, '[(07:10)][0] sport run (30min) + news crypto')
    ...
    call append(l:tomorrow_loc + 1, '[(19:05)][0] dinner + @ic study (youtube)')
    ...
    " call append(l:tomorrow_loc + 1, '[][0] home sport Xmin + news crypto')
