augroup filetype_c
    ...
    if  (expand('%:t:r') =~# "[A-Z]")
        ...
        if &background == "dark"
            ...
            au FileType c hi cString ctermfg=102
            au FileType cpp hi cppString ctermfg=102
        ...
        elseif &background == "light"
            ...
            au FileType c hi cString ctermfg=245
            au FileType cpp hi cppString ctermfg=245
