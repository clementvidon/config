augroup FILETYPE_C
    ...
    au FileType c,cpp setl path+=include/**,../include/**,src/**,../src/**
    ...
    "   MARKER
    au Filetype c nn <silent><buffer> <Space>m mmodprintf(2, "---[%s/%s()/l.%d/%s]---\n",
                \__FILE__, __func__, __LINE__, __TIME__);<Esc>==f%
