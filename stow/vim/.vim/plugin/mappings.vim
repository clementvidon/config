...
nn <silent> scA :e $HOME/.vim/init/autocmd.vim<CR>gi<Esc>
nn <silent> scC :e $HOME/.vim/init/command.vim<CR>gi<Esc>
nn <silent> scO :e $HOME/.vim/init/option.vim<CR>gi<Esc>
nn <silent> scP :e $HOME/.vim/init/plugin.vim<CR>gi<Esc>
nn <silent> scM :e $HOME/.vim/plugin/mappings.vim<CR>gi<Esc>
...
"   clipboard
nn <silent> <Leader>y :call system(executable('pbcopy') ? 'pbcopy' : 'xclip -sel clip', getreg('"'))<CR>
